...
def forcef_t(x,y,t,alpha):
    return np.sin(2.0*x)*np.cos(3.0*y)*2.5*t**(1.5)-alpha*t**(2.5)*(-4.0*np.sin(2.0*x)*np.cos(3.0*y)-9.0*np.sin(2.0*x)*np.cos(3.0*y))+Ux_t(x,y,t)*2.0*np.cos(2.0*x)*np.cos(3.0*y)*t**(2.5)-Uy_t(x,y,t)*3.0*np.sin(2.0*x)*np.sin(3.0*y)*t**(2.5)
  #  return 2.0*np.cos(2.0*x)*np.cos(3.0*y)-3.0*np.sin(2.0*x)*np.sin(3.0*y)-alpha*(-4.0*np.sin(2.0*x)*np.cos(3.0*y)-9.0*np.sin(2.0*x)*np.cos(3.0*y))
